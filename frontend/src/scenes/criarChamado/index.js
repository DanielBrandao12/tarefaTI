...
function CriarChamado() {
  ...
  const updateTicket = async () => {
    ...
    if (isUnchanged) {
      setMessage(
        "Nenhuma alteração detectada. Por favor faça uma alteração antes de salvar!"
      );
      setPopupVisible(true);
      return;
    }
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        console.warn(
          "Falha ao atualizar o ticket. Código de status:",
          response.status
        );
      }
    } catch (error) {
  ...
  return (
    <PaginaPadrao>
      ...
      <Card>
        <h1 className={styles.titleFormChamado}>
          {id_ticket.id ? "Editar Chamado" : "Abrir Chamado"}
        </h1>
            ...
            <div className={stylesGlobal.containerMessageInput}>
              <select
                ...
                className={[
                  ...
                  error.idCategoria && stylesGlobal.errorInput,
                ].join(" ")}
                value={idCategoria}
                onChange={(e) => {
              ...
              {error.idCategoria && (
                <span className={stylesGlobal.errorMessage}>
                  Campo obrigatório
                </span>
              )}
            </div>
            ...
            <div className={stylesGlobal.containerMessageInput}>
              <input
                ...
                className={[
                  ...
                  error.nomeReq && stylesGlobal.errorInput,
                ].join(" ")}
                value={nomeReq}
                onChange={(e) => {
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={stylesGlobal.containerMessageInput}>
              <input
                ...
                onChange={(e) => {
                  const value = e.target.value;
                  const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/; // Expressão regular para validação de e-mail
              ...
              {error.emailReq && (
                <span className={stylesGlobal.errorMessage}>
                  Campo obrigatório. Por favor, insira um endereço de e-mail
                  válido.
                </span>
              )}
            </div>
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={stylesGlobal.containerMessageInput}>
              <input
                ...
                className={[
                  stylesGlobal.inputTextChamado,
                  error.assunto && stylesGlobal.errorInput,
                ].join(" ")}
                value={assunto}
                onChange={(e) => {
                  const value = e.target.value;
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={stylesGlobal.containerMessageInput}>
              <select
                ...
                className={[
                  stylesGlobal.selectChamado,
                  error.prioridade && stylesGlobal.errorInput,
                ].join(" ")}
                value={prioridade}
                onChange={(e) => {
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={stylesGlobal.containerMessageInput}>
              <select
                ...
                className={[
                  stylesGlobal.selectChamado,
                  error.idStatus && stylesGlobal.errorInput,
                ].join(" ")}
                value={idStatus}
                onChange={(e) => {
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={stylesGlobal.containerMessageInput}>
              <select
                ...
                className={[
                  stylesGlobal.selectChamado,
                  error.atribuir && stylesGlobal.errorInput,
                ].join(" ")}
                value={atribuir}
                onChange={(e) => {
